...
import { Heart, Video, Camera, Chrome } from 'lucide-react';
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-3xl p-6 border border-white/20 shadow-2xl">
          <form onSubmit={handleStartChat} className="space-y-4">
            ...
            <a
              href="/api/auth/login"
              className="flex items-center justify-center gap-3 w-full bg-white hover:bg-gray-50 text-gray-700 font-semibold py-3 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
              {/* Google icon SVG */}
